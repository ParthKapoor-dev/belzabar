...
console.log(`✅ registry-help.ts    (embedded help text for ${adCommands.length + pdCommands.length + twCommands.length + topLevelCommands.length + migrateCommands.length} commands)`);
