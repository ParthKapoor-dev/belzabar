...
export async function cachedFetchPageConfig(pageId: string): Promise<PageConfigResponse | null> {
...
export async function cachedFetchComponentConfig(componentId: string): Promise<PageConfigResponse | null> {
